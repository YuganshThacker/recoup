...
padding:16px;margin:12px 0;min-height:120px;max-height:56vh;overflow-y:auto;
position:sticky;top:8px;z-index:5;box-shadow:0 8px 24px rgba(0,0,0,.55)}
...
function render(){
  ...
  const cap = shown >= 80 ? ' (first 80 \u2014 filter to narrow)' : '';
  document.getElementById('count').textContent = shown + ' of ' + rows.length + cap;
}
